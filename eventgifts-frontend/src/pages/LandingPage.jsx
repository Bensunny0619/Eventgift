        ...
        <div className="bg-exquisite-cream dark:bg-exquisite-midnight text-slate-900 dark:text-white transition-colors duration-500">
                ...
                <div className="max-w-[1400px] mx-auto px-10 relative z-10">
                    <div className="max-w-4xl">
                        <div className="inline-flex items-center space-x-3 px-6 py-2 bg-exquisite-gold/10 border border-exquisite-gold/20 rounded-full mb-10 animate-in fade-in slide-in-from-left-4 duration-1000">
                            ...
                            <span className="text-[10px] font-black uppercase tracking-[0.3em] text-exquisite-gold">Smart Event Gifting</span>
                        </div>
                        ...
                        <h1 className="text-4xl sm:text-6xl md:text-8xl font-serif leading-[1.1] mb-8 sm:mb-12 animate-in fade-in slide-in-from-bottom-8 duration-1000 delay-300">
                            Where <span className="text-exquisite-gold">beautiful</span> moments meet true gratitude.
                        </h1>
                        ...
                        <p className="text-lg md:text-2xl text-slate-600 dark:text-slate-400 mb-10 sm:mb-16 max-w-2xl leading-relaxed animate-in fade-in slide-in-from-bottom-8 duration-1000 delay-500">
                            Create gift registries, invite your friends and family, and say thank you with personalized video messages.
                        </p>
            ...
            <section className="py-32 bg-white dark:bg-exquisite-midnight border-y border-slate-100 dark:border-white/5">
                <div className="max-w-[1400px] mx-auto px-10">
                    <div className="text-center max-w-3xl mx-auto mb-16 sm:mb-24">
                        <h2 className="text-3xl md:text-6xl font-serif mb-6 sm:mb-8 italic">The Premium Standard</h2>
                        <p className="text-base sm:text-lg text-slate-500 dark:text-slate-400 font-medium tracking-tight">Everything you need to manage your event gifts perfectly.</p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-12">
                        {[
                            ...
                            },
                            {
                                ...
                                title: "Gift Support",
                                desc: "Helpful support to guide your guests in choosing the perfect gift for you."
                            }
                        ].map((feature, i) => (
                ...
                <div className="max-w-[1200px] mx-auto px-10 text-center">
                    <div className="exquisite-card p-20 dark:bg-slate-900/40 relative overflow-hidden">
                        ...
                        <div className="relative z-10 space-y-12">
                            <h2 className="text-4xl sm:text-5xl md:text-7xl font-serif max-w-4xl mx-auto leading-tight italic">Your event awaits.</h2>
                            <p className="text-lg sm:text-xl text-slate-500 dark:text-slate-400 max-w-xl mx-auto font-medium">Join Eventgift and turn your next celebration into a truly special experience.</p>
                            <div className="pt-6">
            ...
            <footer className="py-20 border-t border-slate-100 dark:border-white/5 opacity-50">
                <div className="max-w-[1400px] mx-auto px-10 flex flex-col md:flex-row justify-between items-center space-y-8 md:space-y-0">
                    <span className="text-2xl font-black tracking-tighter">Eventgift</span>
                    <p className="text-[10px] font-black uppercase tracking-[0.5em] text-slate-400">© 2026 Eventgift Registry. All Rights Reserved.</p>
