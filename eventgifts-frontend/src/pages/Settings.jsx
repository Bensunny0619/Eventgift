                ...
                <div className="lg:col-span-3">
                    ...
                    {activeTab === 'Security' && (
                        <div className="exquisite-card p-10 space-y-10 animate-in fade-in slide-in-from-right-4 duration-500">
                            ...
                            <div className="pt-6">
                                <button className="px-10 py-5 bg-slate-900 dark:bg-white text-white dark:text-slate-900 rounded-2xl font-bold shadow-2xl hover:scale-[1.02] transition-all">Update Security</button>
                            </div>
                        </div>
                    )}
