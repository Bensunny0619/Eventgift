            ...
            <div className="w-full max-w-xl z-10 animate-in fade-in slide-in-from-bottom-8 duration-1000">
                <div className="exquisite-card p-8 sm:p-12 md:p-16">
                    <div className="text-center mb-10 sm:mb-12">
                        ...
                        <h1 className="text-3xl sm:text-5xl font-serif text-slate-900 dark:text-white mb-4">Create your account</h1>
                        <p className="text-sm sm:base text-slate-500 font-medium">Join the simplest event gifting platform.</p>
                    </div>
                    ...
                    <div className="mt-12 text-center">
                        <p className="text-slate-500 font-bold">
                            Already a member? {' '}
                            <Link to="/login" className="text-exquisite-gold hover:underline">Log in here</Link>
                        </p>
                    </div>
                </div>
            </div>
