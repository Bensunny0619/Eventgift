            ...
            <div className="w-full max-w-xl z-10 animate-in fade-in slide-in-from-bottom-8 duration-1000">
                <div className="exquisite-card p-12 md:p-16">
                    <div className="text-center mb-12">
                        ...
                        <h1 className="text-5xl font-serif text-slate-900 dark:text-white mb-4 italic">Private Membership</h1>
                        <p className="text-slate-500 font-medium">Join the most prestigious event ecosystem.</p>
                    </div>
